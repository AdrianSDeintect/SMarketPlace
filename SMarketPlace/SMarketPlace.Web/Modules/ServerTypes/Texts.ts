...
namespace SMarketPlace.Texts {
    ...
    export declare namespace Db {
        ...
        namespace Ecommerce {
            ...
            namespace ActualizarPedido {
                export const DtCambio: string;
                export const DtRegistroUsr: string;
                export const Estado: string;
                export const EstadoPedidoInternet: string;
                export const IdPedidoEcommerce: string;
                export const Intid: string;
            }

            namespace AlertaPromociones {
            ...
            namespace OrdenesEcommerce {
                export const Consecutivo: string;
                export const EstadoPedidoInternet: string;
                export const IdPedidoEcommerce: string;
            }
        ...
        namespace Log {
            ...
            namespace PreciosStockRappi {
                export const Discount: string;
                export const DiscountPrice: string;
                export const DtRegistro: string;
                export const Gtin: string;
                export const Id: string;
                export const Intid: string;
                export const IsAvailable: string;
                export const IsDiscontinued: string;
                export const Name: string;
                export const Price: string;
                export const SaleType: string;
                export const Stock: string;
                export const StoreId: string;
            }

            namespace PreciosStockUber {
                export const Discount: string;
                export const DiscountPrice: string;
                export const DtRegistro: string;
                export const Gtin: string;
            ...
            namespace Promocionesuber {
                export const Consecutivo: string;
                export const EndDate: string;
                export const FormatDescription: string;
                export const FormatDescriptionShort: string;
