...
public sealed class AlertaPromocionesRow : Row<AlertaPromocionesRow.RowFields>, IIdRow, INameRow
{
    ...
    [DisplayName("Map Cod"), Column("MAP_COD"), Size(500), QuickSearch]
    ...
    [DisplayName("Mecanica"), Column("MECANICA"), Size(500), QuickSearch]
    ...
    [DisplayName("Descripcion Promocion"), Column("DESCRIPCION_PROMOCION"), Size(500), QuickSearch]
    ...
    [DisplayName("Inicio Vigencia"), Column("INICIO_VIGENCIA"), Size(500), QuickSearch]
    ...
    [DisplayName("Fin Vigencia"), Column("FIN_VIGENCIA"), Size(500), QuickSearch]
    ...
    [DisplayName("Descripcion Corta"), Column("DESCRIPCION_CORTA"), Size(500), QuickSearch]
    ...
    [DisplayName("Lealtad Codigo Acumula"), Column("Lealtad_Codigo_Acumula"), Size(500), QuickSearch]
