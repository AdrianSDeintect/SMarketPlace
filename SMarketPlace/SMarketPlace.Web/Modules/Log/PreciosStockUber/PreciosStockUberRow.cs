...
[ConnectionKey("Default"), Module("Log"), TableName("PreciosStockUber")]
[DisplayName("Precios Stock Uber"), InstanceName("Precios Stock Uber")]
[ReadPermission(PermissionKeys.LogProcesos)]
[ModifyPermission(PermissionKeys.LogProcesos)]
public sealed class PreciosStockUberRow : Row<PreciosStockUberRow.RowFields>, IIdRow, INameRow
{
